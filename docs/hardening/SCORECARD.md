...
Updated: 2026-09-01 M1 complete, active M2 reader/printer, macro, cap, and malformed slices green. Scale: 0
...
| --- | ---: | --- | --- |
| Semantic correctness | 2 | M0 is 301/301; M1 adds 15 reviewed cases/17 events with no divergence; M2 adds seeded reader/printer and pinned macro properties, exact caps, and 12 reader-error fixtures | Nested quasiquote/splice and broader generated source-form properties |
...
| Code size / instructions | 2 | Current seed is 10,465 bytes with 4,264 static instruction lines; layer bytes/hashes and one 43-byte AOT artifact are recorded | Automated per-stage size/static count and representative dynamic counts |
...
| Property/fuzz and malformed caps | Seeded acyclic-data property, 12 malformed reader fixtures, binary shrink 511/512, exact 32,768/32,769 work boundary, 130,048-byte host cap, and minimal self-expanding macro witness | M2 generated source forms and nested quasiquote/splice |
...
boundaries. The earliest remaining gap is nested quasiquote/unquote-splicing,
followed by broader generated source-form idempotence. M2 is active.
