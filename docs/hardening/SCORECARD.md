...
Updated: 2026-09-01 M1 complete, active M2 reader/printer, macro, cap, malformed, and quasiquote slices green. Scale: 0
...
| --- | ---: | --- | --- |
| Semantic correctness | 2 | M0 is 301/301; M1 adds 15 reviewed cases/17 events with no divergence; M2 adds seeded reader/printer and pinned macro properties, exact caps, 12 reader-error fixtures, and matching-depth quasiquote/splice checks | Broader generated source-form properties |
...
| Macro expansion determinism | Independent named outer expansion; 8 authored cases hash `34214d55...` across 4 fresh and 16 warmed corpus runs; produced user mutation is not evaluated; step 1,025 fails explicitly; 4 quasiquote groups cover nesting, context, list shape, and arity | M2 broader generated source forms |
| IR/decompile invariants | No IR | M4 |
| Property/fuzz and malformed caps | Seeded acyclic-data property, 12 malformed reader fixtures, 4 quasiquote groups, binary shrink 511/512, exact 32,768/32,769 work boundary, 130,048-byte host cap, and minimal self-expanding macro witness | M2 generated source forms |
...
boundaries. Four quasiquote groups now cover matching-depth unquote/splicing,
valid order, invalid context/list shape, and exact arity. The earliest remaining
gap is broader generated source-form idempotence. M2 is active.
